...
env = Env('CreateLevelCustomPush-v0',False, 1, 1000, 2, 10)
...
args.episodes = 50700
args.experience_replay = '/home/soham/USC/Courses/CSCI566_DeepLearning/CREATE/PlaNet/Replay_10000_4_tools.pth'
...
observation_model = ObservationModel(args.symbolic_env, env.observation_size, args.belief_size, args.state_size, args.embedding_size, args.activation_function,out_channels=1).to(device=args.device)
...
encoder = Encoder(args.symbolic_env, env.observation_size, args.embedding_size, args.activation_function,in_channels).to(device=args.device)
...
planner_1 = MPCPlanner(env.action_size, args.planning_horizon, args.optimisation_iters, args.candidates, args.top_candidates, transition_model, reward_model, -1, 1,num_tools)
...
for episode in tqdm(range(metrics['episodes'][-1] + 1, args.episodes + 1), total=args.episodes, initial=metrics['episodes'][-1] + 1):
  ...
  if episode % args.test_interval == 0:
    ...
    # env_num = random.randint(1,5)
    test_envs = EnvBatcher(Env, ('CreateLevelCustomPush-v0', args.symbolic_env, args.seed, args.max_episode_length, args.action_repeat, args.bit_depth), {}, args.test_episodes)
