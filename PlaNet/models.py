...
class VisualObservationModel(jit.ScriptModule):
  ...
  def __init__(self, belief_size, state_size, embedding_size, out_channels, activation_function='relu'):
    super().__init__()
    self.act_fn = getattr(F, activation_function)
...
def ObservationModel(symbolic, observation_size, belief_size, state_size, embedding_size, activation_function='relu',out_channels=3):
  if symbolic:
    return SymbolicObservationModel(observation_size, belief_size, state_size, embedding_size, activation_function)
  else:
    return VisualObservationModel(belief_size, state_size, embedding_size, out_channels,activation_function)
...
class VisualEncoder(jit.ScriptModule):
  ...
  def __init__(self, embedding_size, in_channels,activation_function='relu'):
    super().__init__()
    self.act_fn = getattr(F, activation_function)
    self.embedding_size = embedding_size
...
def Encoder(symbolic, observation_size, embedding_size, activation_function='relu',in_channels = 3):
  if symbolic:
    return SymbolicEncoder(observation_size, embedding_size, activation_function)
  else:
    return VisualEncoder(embedding_size, in_channels,activation_function)
